...
public class PayPalCreateSubscriptionReqValidator : ModelValidator<PayPalCreateSubscriptionReq> {
    public PayPalCreateSubscriptionReqValidator(IFormatter formatter) : base(formatter) {
