...
public class IfIsNotAnyOfBlockHelper : BlockHelper {
    public IfIsNotAnyOfBlockHelper(ILogger<IfIsNotAnyOfBlockHelper> logger, IJsonProvider jsonProvider)
        : base(logger, jsonProvider, 2, 100) { }
    
    public override string Name => "if_is_not_any_of";
