...
public class IfMoreThanBlockHelper : BlockHelper {
    public IfMoreThanBlockHelper(ILogger<IfMoreThanBlockHelper> logger, IJsonProvider jsonProvider)
        : base(logger, jsonProvider, 2) { }
    
    public override string Name => "if_more_than";
