...
public class IfLastBlockHelper : BlockHelper {
    public IfLastBlockHelper(ILogger<IfLastBlockHelper> logger, IJsonProvider jsonProvider)
        : base(logger, jsonProvider, 2) { }
    
    public override string Name => "if_last";
