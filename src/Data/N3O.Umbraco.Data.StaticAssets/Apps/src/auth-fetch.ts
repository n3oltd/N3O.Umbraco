...
// backoffice runtime (`@n3o/backoffice-core` from N3O.Umbraco.Cms App_Plugins/N3O.Umbraco.ReactRuntime) and is
...
// (createAuthFetch / UmbAuthFetchMixin) directly from `@n3o/backoffice-core`.
//
...
export type { AuthFetch } from '@n3o/backoffice-core';
