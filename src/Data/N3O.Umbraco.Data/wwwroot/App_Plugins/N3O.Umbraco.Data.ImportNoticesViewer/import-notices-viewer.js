...
function y({ value: e }) {
  const r = (e == null ? void 0 : e.errors) ?? null, t = (e == null ? void 0 : e.warnings) ?? null, c = !!r && r.length > 0, s = !!t && t.length > 0;
  return /* @__PURE__ */ v("div", { className: "n3o-import-errors-viewer", children: [
    c ? /* @__PURE__ */ v(f, { children: [
      ...
      r.map((o, l) => /* @__PURE__ */ n("div", { className: "row-wrapper", children: /* @__PURE__ */ n("div", { className: "row", children: o }) }, `error-${o}-${l}`))
    ] }) : null,
    s ? /* @__PURE__ */ v(f, { children: [
      /* @__PURE__ */ n("p", { children: /* @__PURE__ */ n("em", { className: "text-warning", children: "Warnings" }) }),
      t.map((o, l) => /* @__PURE__ */ n("div", { className: "row-wrapper", children: /* @__PURE__ */ n("div", { className: "row", children: o }) }, `warning-${o}-${l}`))
    ] }) : null,
    !c && !s ? /* @__PURE__ */ n("div", { className: "row-wrapper", children: /* @__PURE__ */ n("div", { className: "row", children: "No warnings or errors" }) }) : null,
...
var M = Object.getOwnPropertyDescriptor, E = (e) => {
  ...
  for (var s = c > 1 ? void 0 : c ? M(r, t) : r, o = e.length - 1, l; o >= 0; o--)
    (l = e[o]) && (s = l(s) || s);
  return s;
