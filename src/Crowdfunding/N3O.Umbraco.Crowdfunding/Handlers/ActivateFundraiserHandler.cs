...
public class ActivateFundraiserHandler : IRequestHandler<ActivateFundraiserCommand, None, None> {
    private readonly IContentService _contentService;
    private readonly ILookups _lookups;

    public ActivateFundraiserHandler(IContentService contentService, ILookups lookups) {
