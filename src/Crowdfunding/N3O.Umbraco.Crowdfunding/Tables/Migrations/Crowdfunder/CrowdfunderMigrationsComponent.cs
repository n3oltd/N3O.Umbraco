...
public class CrowdfunderMigrationsComponent : IComponent {
    ...
    public CrowdfunderMigrationsComponent(IRuntimeState runtimeState,
    ...
    public void Initialize() {
        if (_runtimeState.Level == RuntimeLevel.Run) {
            var migrationPlan = new MigrationPlan(Tables.Crowdfunders.Name);
            migrationPlan.From(string.Empty).To<CrowdfunderMigration>("v1");
