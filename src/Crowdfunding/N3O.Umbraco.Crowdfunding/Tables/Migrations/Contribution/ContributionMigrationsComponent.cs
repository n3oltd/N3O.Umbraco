...
public class ContributionMigrationsComponent : IComponent {
    ...
    public ContributionMigrationsComponent(IRuntimeState runtimeState,
    ...
    public void Initialize() {
        if (_runtimeState.Level == RuntimeLevel.Run) {
            var migrationPlan = new MigrationPlan(Tables.Contributions.Name);
            migrationPlan.From(string.Empty).To<ContributionMigration>("v1");
