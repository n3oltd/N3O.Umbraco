...
public class CrowdfunderRevisionMigrationsComponent : IComponent {
    ...
    public void Initialize() {
        if (_runtimeState.Level == RuntimeLevel.Run) {
            var migrationPlan = new MigrationPlan(Tables.CrowdfunderRevisions.Name);
            migrationPlan.From(string.Empty).To<CrowdfunderRevisionMigration>("v1");
