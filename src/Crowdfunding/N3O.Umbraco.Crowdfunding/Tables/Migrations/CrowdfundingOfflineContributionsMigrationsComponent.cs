...
public class CrowdfundingOfflineContributionsMigrationsComponent : IComponent {
    ...
    public CrowdfundingOfflineContributionsMigrationsComponent(IRuntimeState runtimeState,
    ...
    public void Initialize() {
        if (_runtimeState.Level == RuntimeLevel.Run) {
            var migrationPlan = new MigrationPlan(CrowdfundingConstants.Tables.CrowdfundingOfflineContributions.Name);
            migrationPlan.From(string.Empty).To<CrowdfundingOfflineContributionsMigration>("v1");
