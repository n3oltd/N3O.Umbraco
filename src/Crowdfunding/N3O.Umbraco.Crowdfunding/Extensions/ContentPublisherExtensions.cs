...
public static class ContentPublisherExtensions {
    public static void SetContentValues(this IContentPublisher contentPublisher,
        ...
        contentPublisher.Content.Label(Fundraiser.Properties.Title).Set(req.Name);
    ...
    private static void PopulateAllocations(IContentPublisher contentPublisher,
        ...
        foreach (var fundraiserAllocation in fundraiserAllocations) {
            if (fundraiserAllocation.Type == AllocationTypes.Fund) {
                AddFundAllocation(nestedContent.Add(FundraiserAllocation.Alias), fundraiserAllocation);
