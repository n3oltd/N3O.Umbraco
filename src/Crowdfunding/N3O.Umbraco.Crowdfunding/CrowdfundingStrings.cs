...
public class CrowdfundingStrings : CodeStrings {
    ...
    public string CampaignVideoUrl = "YouTube URL";
    public string CampaignVideoUrlPlaceholder = "e.g. https://www.youtube.com/embed/...";
    public string Cancel => "Cancel";
    public string Close => "Close";
    public string CreateFundraiserError => "Failed to create fundraiser";
    public string CropperClose => "Please save your crop settings first";
