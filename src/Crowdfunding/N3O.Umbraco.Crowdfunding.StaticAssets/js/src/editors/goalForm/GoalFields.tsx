    ...
    return (
        <div className="editGoal__body">
            ...
            {(selectedGoal?.dimension1?.allowedOptions as any[])?.length > 1 ? <>
                <h4 className="dimension-1" >Select Dimension 1</h4>
                <div className="select__outer dimension-1" id="dimension-1">
                    <div className="select">
                        <div className="select__selected">{selectedGoal?.dimension1?.allowedOptions?.find(d => d.id === goal?.dimension1)?.name || 'Select Dimension'}</div>
                        ...
                        <ul className="select__options">
                            <div className="select__search">
                                ...
                                <input type="text" id="goals-dimension-1" placeholder="Type to search..." onKeyUp={() => n3o_cdf_filterList('goals-dimension-1', 'goal-selection-dimension-1')} />
                            </div>
            ...
            {(selectedGoal?.dimension2?.allowedOptions as any[])?.length > 1 ? <>
                <h4 className="dimension-2" > Select Dimension 2</h4>
                <div className="select__outer dimension-2" id="dimension-2">
                    <div className="select">
                        <div className="select__selected">{selectedGoal?.dimension2?.allowedOptions?.find(d => d.id === goal?.dimension2)?.name || 'Select Dimension'}</div>
                        ...
                        <ul className="select__options">
                            <div className="select__search">
                                ...
                                <input type="text" id="goals-dimension-2" placeholder="Type to search..." onKeyUp={() => n3o_cdf_filterList('goals-dimension-2', 'goal-selection-dimension-2')} />
                            </div>
            ...
            {(selectedGoal?.dimension3?.allowedOptions as any[])?.length > 1 ? <>
                <h4 className="dimension-3" >Select Dimension 3</h4>
                <div className="select__outer dimension-3" id="dimension-3">
                    <div className="select">
                        <div className="select__selected">{selectedGoal?.dimension3?.allowedOptions?.find(d => d.id === goal?.dimension3)?.name || 'Select Dimension'}</div>
                        ...
                        <ul className="select__options">
                            <div className="select__search">
                                ...
                                <input type="text" id="goals-dimension-3" placeholder="Type to search..." onKeyUp={() => n3o_cdf_filterList('goals-dimension-3', 'goal-selection-dimension-3')} />
                            </div>
            ...
            {(selectedGoal?.dimension4?.allowedOptions as any[])?.length > 1 ? <>
                <h4 className="dimension-4" >Select Dimension 4</h4>
                <div className="select__outer dimension-4" id="dimension-4">
                    <div className="select">
                        <div className="select__selected">{selectedGoal?.dimension4?.allowedOptions?.find(d => d.id === goal?.dimension4)?.name || 'Select Dimension'}</div>
                        ...
                        <ul className="select__options">
                            <div className="select__search">
                                ...
                                <input type="text" id="goals-dimension-4" placeholder="Type to search..." onKeyUp={() => n3o_cdf_filterList('goals-dimension-4', 'goal-selection-dimension-4')} />
                            </div>
