...
public class MembersAccessControl : IMembersAccessControl {
    ...
    public MembersAccessControl(IEnumerable<IContentAccessControl> contentAccessControls, IContentService contentService, IMemberManager memberManager, IMemberService memberService) {
