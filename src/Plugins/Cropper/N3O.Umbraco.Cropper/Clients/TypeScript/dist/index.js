...
var Cropper = /** @class */ (function () {
    function Cropper(baseUrl, http) {
        this.jsonParseReviver = undefined;
        this.http = http ? http : window;
        this.baseUrl = baseUrl !== undefined && baseUrl !== null ? baseUrl : "https://localhost:5001";
    }
    Cropper.prototype.add = function (req) {
        var _this = this;
    ...
    Cropper.prototype.processAdd = function (response) {
        var _this = this;
    ...
    Cropper.prototype.getSummary = function () {
        var _this = this;
    ...
    Cropper.prototype.processGetSummary = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
    ...
    Cropper.prototype.remove = function (allocationNumber) {
        var _this = this;
    ...
    Cropper.prototype.processRemove = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
