...
public class QurbaniOfferingValidator : OfferingValidator {
    private readonly ILookups _lookups;

    public QurbaniOfferingValidator(IContentHelper contentHelper, ILookups lookups, IFundStructureAccessor fundStructureAccessor) : base(contentHelper, lookups, fundStructureAccessor) {
        _lookups = lookups;
    }
    ...
    protected override string ContentTypeAlias => PlatformsConstants.Offerings.Qurbani;
}
