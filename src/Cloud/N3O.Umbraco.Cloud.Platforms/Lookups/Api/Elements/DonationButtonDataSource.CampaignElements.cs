...
public class DonationButtonCampaignElementsDataSource : IContentmentDataSource {
    private readonly ILookups _lookups;

    public DonationButtonCampaignElementsDataSource(ILookups lookups) {
        _lookups = lookups;
    }
    
    public string Name => "Donation Button (Campaign) Elements";
    public string Description => "Data source for campaign donation button elements";
    ...
    public IEnumerable<DataListItem> GetItems(Dictionary<string, object> config) {
        return _lookups.GetAll<Element>()
                       .Where(x => x.ElementKind == ElementKind.DonationButtonCampaign)
