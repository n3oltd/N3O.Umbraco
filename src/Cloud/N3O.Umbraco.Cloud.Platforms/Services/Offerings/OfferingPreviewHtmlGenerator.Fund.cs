...
public class FundOfferingPreviewHtmlGenerator : OfferingPreviewHtmlGenerator {
    private readonly IJsonProvider _jsonProvider;
    private readonly ILookups _lookups;

    public FundOfferingPreviewHtmlGenerator(ICdnClient cdnClient,
    ...
    protected override OurAllocationType OfferingAllocationType => AllocationTypes.Fund;
