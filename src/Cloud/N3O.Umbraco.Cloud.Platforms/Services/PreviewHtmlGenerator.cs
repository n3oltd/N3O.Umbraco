...
public abstract class PreviewHtmlGenerator : IPreviewHtmlGenerator {
    private readonly ICdnClient _cdnClient;
    private readonly IJsonProvider _jsonProvider;
    private readonly ILookups _lookups;

    protected PreviewHtmlGenerator(ICdnClient cdnClient, IJsonProvider jsonProvider, ILookups lookups) {
    ...
    public async Task<(string ETag, string Html)> GeneratePreviewHtmlAsync(IReadOnlyDictionary<string, object> content) {
