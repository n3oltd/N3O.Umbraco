...
public class PlatformsOfferingMetadataProvider : PlatformsMetadataProvider {
    public PlatformsOfferingMetadataProvider(IPlatformsPageAccessor platformsPageAccessor) 
