...
namespace N3O.Umbraco.Cloud.Platforms.Clients
{
    ...
    /// <summary>
    /// One of 'almostCompleteFeaturedCrowdfunders', 'contentFeedCollection', 'contentFeedCustom', 'contentFeedLibrary', 'createCrowdfunderButton', 'createCrowdfunderButtonCampaign', 'createCrowdfunderButtonCustom', 'customFeaturedCrowdfunders', 'donationButton', 'donationButtonCampaign', 'donationButtonCustom', 'donationButtonMenu', 'donationButtonOffering', 'donationButtonQurbaniGroup', 'donationButtonQurbaniLocation', 'donationForm', 'donationFormCampaign', 'donationFormCustom', 'donationFormMenu', 'donationFormOffering', 'donationFormQurbaniGroup', 'donationFormQurbaniLocation', 'donationPopup', 'donationPopupCampaign', 'donationPopupCustom', 'donationPopupMenu', 'donationPopupOffering', 'donationPopupQurbaniGroup', 'donationPopupQurbaniLocation', 'endingSoonFeaturedCrowdfunders', 'popularFeaturedCrowdfunders', 'recentlyStartedFeaturedCrowdfunders'
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.6.0.0 (NJsonSchema v11.5.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum ElementKind
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"donationButtonQurbaniGroup")]
        DonationButtonQurbaniGroup = 13,

        [System.Runtime.Serialization.EnumMember(Value = @"donationButtonQurbaniLocation")]
        DonationButtonQurbaniLocation = 14,
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"donationFormQurbaniGroup")]
        DonationFormQurbaniGroup = 20,

        [System.Runtime.Serialization.EnumMember(Value = @"donationFormQurbaniLocation")]
        DonationFormQurbaniLocation = 21,

        [System.Runtime.Serialization.EnumMember(Value = @"donationPopup")]
        DonationPopup = 22,

        [System.Runtime.Serialization.EnumMember(Value = @"donationPopupCampaign")]
        DonationPopupCampaign = 23,

        [System.Runtime.Serialization.EnumMember(Value = @"donationPopupCustom")]
        DonationPopupCustom = 24,

        [System.Runtime.Serialization.EnumMember(Value = @"donationPopupMenu")]
        DonationPopupMenu = 25,

        [System.Runtime.Serialization.EnumMember(Value = @"donationPopupOffering")]
        DonationPopupOffering = 26,

        [System.Runtime.Serialization.EnumMember(Value = @"donationPopupQurbaniGroup")]
        DonationPopupQurbaniGroup = 27,

        [System.Runtime.Serialization.EnumMember(Value = @"donationPopupQurbaniLocation")]
        DonationPopupQurbaniLocation = 28,

        [System.Runtime.Serialization.EnumMember(Value = @"endingSoonFeaturedCrowdfunders")]
        EndingSoonFeaturedCrowdfunders = 29,

        [System.Runtime.Serialization.EnumMember(Value = @"popularFeaturedCrowdfunders")]
        PopularFeaturedCrowdfunders = 30,

        [System.Runtime.Serialization.EnumMember(Value = @"recentlyStartedFeaturedCrowdfunders")]
        RecentlyStartedFeaturedCrowdfunders = 31,
