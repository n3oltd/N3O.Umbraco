...
public class PlatformsCampaignPublished : INotificationAsyncHandler<ContentPublishingNotification> {
    private readonly IContentTypeService _contentTypeService;
    private readonly Lazy<IBackgroundJob> _backgroundJob;

    public PlatformsCampaignPublished(IContentTypeService contentTypeService, Lazy<IBackgroundJob> backgroundJob) {
