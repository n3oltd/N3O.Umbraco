...
public class PlatformsPageRoute : Value {
    ...
    public static readonly PlatformsPageRoute[] All = [
        ...
        new(SpecialPages.Donate, PublishedFileKinds.Campaign),
        new(SpecialPages.Donate, PublishedFileKinds.Offering),
        new(SpecialPages.Fundraise, PublishedFileKinds.Crowdfunder)
    ];
}