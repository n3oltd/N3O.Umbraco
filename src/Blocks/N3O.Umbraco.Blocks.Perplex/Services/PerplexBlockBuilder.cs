...
public abstract class PerplexBlockBuilder : IPerplexBlockBuilder {
    private readonly List<ILayoutBuilder> _layoutBuilders = [];
    private readonly List<PerplexBlockCategory> _categories = [];
    private readonly List<string> _limitToContentTypes = [];
