...
namespace N3O.Umbraco.Clients.Giving.Checkout
{
        ...
        public virtual async System.Threading.Tasks.Task<CheckoutRes> GetCurrentCheckoutAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "umbraco/api/Checkout/current"
                    urlBuilder_.Append("umbraco/api/Checkout/current");
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NamedLookupRes>> GetLookupCheckoutStagesAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "umbraco/api/Checkout/lookups/checkoutStages"
                    urlBuilder_.Append("umbraco/api/Checkout/lookups/checkoutStages");
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NamedLookupRes>> GetRegularGivingFrequenciesAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "umbraco/api/Checkout/lookups/regularGivingFrequencies"
                    urlBuilder_.Append("umbraco/api/Checkout/lookups/regularGivingFrequencies");
        ...
        public virtual async System.Threading.Tasks.Task<CheckoutRes> UpdateAccountAsync(string checkoutRevisionId, AccountReq req, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "umbraco/api/Checkout/{checkoutRevisionId}/account"
                    urlBuilder_.Append("umbraco/api/Checkout/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(checkoutRevisionId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<CheckoutRes> UpdateAccountConsentAsync(string checkoutRevisionId, ConsentReq req, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "umbraco/api/Checkout/{checkoutRevisionId}/account/consent"
                    urlBuilder_.Append("umbraco/api/Checkout/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(checkoutRevisionId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/account/consent");
        ...
        public virtual async System.Threading.Tasks.Task<CheckoutRes> UpdateAccountTaxStatusAsync(string checkoutRevisionId, TaxStatusReq req, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "umbraco/api/Checkout/{checkoutRevisionId}/account/taxStatus"
                    urlBuilder_.Append("umbraco/api/Checkout/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(checkoutRevisionId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/account/taxStatus");
        ...
        public virtual async System.Threading.Tasks.Task<CheckoutRes> UpdateRegularGivingOptionsAsync(string checkoutRevisionId, RegularGivingOptionsReq req, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "umbraco/api/Checkout/{checkoutRevisionId}/regularGiving/options"
                    urlBuilder_.Append("umbraco/api/Checkout/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(checkoutRevisionId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/regularGiving/options");
        ...
        public virtual async System.Threading.Tasks.Task<CheckoutLookupsRes> GetAllLookupsAsync(LookupsCriteria criteria, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "umbraco/api/Checkout/lookups/all"
                    urlBuilder_.Append("umbraco/api/Checkout/lookups/all");
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.3.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class CaptchaReq
    {
