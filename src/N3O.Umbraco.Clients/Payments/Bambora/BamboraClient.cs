...
namespace N3O.Umbraco.Clients.Payments.Bambora
{
    ...
    public partial interface IBamboraClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PaymentFlowResOfBamboraPayment> StoreCardAsync(string flowId, StoreCardReq req);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PaymentFlowResOfBamboraPayment> StoreCardAsync(string flowId, StoreCardReq req, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class BamboraClient : IBamboraClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<PaymentFlowResOfBamboraPayment> StoreCardAsync(string flowId, StoreCardReq req)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PaymentFlowResOfBamboraPayment> StoreCardAsync(string flowId, StoreCardReq req, System.Threading.CancellationToken cancellationToken)
        {
            if (flowId == null)
                throw new System.ArgumentNullException("flowId");
