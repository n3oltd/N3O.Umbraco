        ...
        public virtual async System.Threading.Tasks.Task<PaymentFlowResOfBamboraPayment> ChargeCardAsync(string flowId, ChargeCardReq req, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "umbraco/api/Bambora/payments/{flowId}/charge"
                    urlBuilder_.Append("umbraco/api/Bambora/payments/");
        ...
        public virtual async System.Threading.Tasks.Task CompletePaymentThreeDSecureAsync(string flowId, string cRes, string paRes, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "umbraco/api/Bambora/payments/{flowId}/completeThreeDSecure"
                    urlBuilder_.Append("umbraco/api/Bambora/payments/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(flowId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<PaymentFlowResOfBamboraCredential> StoreCardAsync(string flowId, StoreCardReq req, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "umbraco/api/Bambora/credentials/{flowId}/store"
                    urlBuilder_.Append("umbraco/api/Bambora/credentials/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(flowId, System.Globalization.CultureInfo.InvariantCulture)));
