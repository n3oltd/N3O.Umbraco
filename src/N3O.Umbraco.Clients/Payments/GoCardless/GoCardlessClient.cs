...
namespace N3O.Umbraco.Clients.Payments.GoCardless
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.18.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v10.0.0.0))")]
    public partial interface IGoCardlessClient
    {
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PaymentFlowResOfGoCardlessCredential> BeginRedirectFlowAsync(string flowId, RedirectFlowReq req);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PaymentFlowResOfGoCardlessCredential> BeginRedirectFlowAsync(string flowId, RedirectFlowReq req, System.Threading.CancellationToken cancellationToken);

        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task CompleteRedirectFlowAsync(string flowId);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task CompleteRedirectFlowAsync(string flowId, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class GoCardlessClient : IGoCardlessClient
    {
        ...
        public GoCardlessClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<PaymentFlowResOfGoCardlessCredential> BeginRedirectFlowAsync(string flowId, RedirectFlowReq req)
        {
            return BeginRedirectFlowAsync(flowId, req, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PaymentFlowResOfGoCardlessCredential> BeginRedirectFlowAsync(string flowId, RedirectFlowReq req, System.Threading.CancellationToken cancellationToken)
        {
            if (flowId == null)
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/umbraco/api/GoCardless/credentials/{flowId}/redirectFlow/begin");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PaymentFlowResOfGoCardlessCredential>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task CompleteRedirectFlowAsync(string flowId)
        {
            return CompleteRedirectFlowAsync(flowId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task CompleteRedirectFlowAsync(string flowId, System.Threading.CancellationToken cancellationToken)
        {
            if (flowId == null)
                throw new System.ArgumentNullException("flowId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/umbraco/api/GoCardless/credentials/{flowId}/redirectFlow/complete");
            urlBuilder_.Replace("{flowId}", System.Uri.EscapeDataString(ConvertToString(flowId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class PaymentFlowResOfGoCardlessCredential
    {
        ...
        public GoCardlessCredential Result { get; set; }
    ...
    public partial class GoCardlessCredential
    {
        ...
        [Newtonsoft.Json.JsonProperty("goCardlessCustomerId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string GoCardlessCustomerId { get; set; }

        [Newtonsoft.Json.JsonProperty("goCardlessRedirectFlowId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string GoCardlessRedirectFlowId { get; set; }

        [Newtonsoft.Json.JsonProperty("goCardlessMandateId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string GoCardlessMandateId { get; set; }

        [Newtonsoft.Json.JsonProperty("goCardlessSessionToken", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string GoCardlessSessionToken { get; set; }

        [Newtonsoft.Json.JsonProperty("goCardlessRedirectUrl", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string GoCardlessRedirectUrl { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v10.0.0.0))")]
    public partial class RedirectFlowReq
    {
        [Newtonsoft.Json.JsonProperty("returnUrl", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ReturnUrl { get; set; }
