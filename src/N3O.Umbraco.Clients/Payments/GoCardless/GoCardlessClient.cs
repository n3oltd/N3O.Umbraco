        ...
        public virtual async System.Threading.Tasks.Task<PaymentFlowResOfGoCardlessCredential> BeginRedirectFlowAsync(string flowId, RedirectFlowReq req, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "umbraco/api/GoCardless/credentials/{flowId}/redirectFlow/begin"
                    urlBuilder_.Append("umbraco/api/GoCardless/credentials/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(flowId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/redirectFlow/begin");
        ...
        public virtual async System.Threading.Tasks.Task CompleteRedirectFlowAsync(string flowId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "umbraco/api/GoCardless/credentials/{flowId}/redirectFlow/complete"
                    urlBuilder_.Append("umbraco/api/GoCardless/credentials/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(flowId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/redirectFlow/complete");
