...
public class DonationCategoryValidator : DonationCategoryValidator<DonationCategoryBaseContent> {
    public DonationCategoryValidator(IContentHelper contentHelper, IContentLocator contentLocator) 
