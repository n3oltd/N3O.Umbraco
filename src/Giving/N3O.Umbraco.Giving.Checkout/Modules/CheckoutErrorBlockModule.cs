...
namespace N3O.Umbraco.Giving.Checkout.Modules {
    public class CheckoutErrorBlockModule : IBlockModule {
        private static readonly string BlockAlias = AliasHelper<CheckoutErrorBlockContent>.ContentTypeAlias();
        
        private readonly ICheckoutAccessor _checkoutAccessor;

        public CheckoutErrorBlockModule(ICheckoutAccessor checkoutAccessor) {
