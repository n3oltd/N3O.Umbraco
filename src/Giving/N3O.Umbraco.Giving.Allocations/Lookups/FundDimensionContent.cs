...
public abstract class ContentFundDimensionContent<T, TContent, TValue> : LookupsCollection<T> 
    ...
    protected ContentFundDimensionContent(IContentCache contentCache) {
...
public class ContentFundDimension1Content :
    ...
    public ContentFundDimension1Content(IContentCache contentCache)
        : base(contentCache) { }
...
public class ContentFundDimension2Content :
    ...
    public ContentFundDimension2Content(IContentCache contentCache)
        : base(contentCache) { }
...
public class ContentFundDimension3Content :
    ...
    public ContentFundDimension3Content(IContentCache contentCache)
        : base(contentCache) { }
...
public class ContentFundDimension4Content :
    ...
    public ContentFundDimension4Content(IContentCache contentCache)
        : base(contentCache) { }
