...
export class ImportClient {
    ...
    getLookupDatePatterns(): Promise<NamedLookupRes[]> {
        let url_ = this.baseUrl + "/umbraco/backoffice/api/Import/lookups/datePatterns";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getTemplate(contentId: string, contentType: string): Promise<void> {
        let url_ = this.baseUrl + "/umbraco/backoffice/api/Import/template/{contentId}/{contentType}";
    ...
    queue(contentId: string, contentType: string, req: QueueImportsReq): Promise<QueueImportsRes> {
        let url_ = this.baseUrl + "/umbraco/backoffice/api/Import/queue/{contentId}/{contentType}";
        if (contentId === undefined || contentId === null)
            throw new Error("The parameter 'contentId' must be defined.");
        url_ = url_.replace("{contentId}", encodeURIComponent("" + contentId));
        if (contentType === undefined || contentType === null)
