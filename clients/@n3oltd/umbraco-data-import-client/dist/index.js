...
var ImportClient = /** @class */ (function () {
    function ImportClient(baseUrl, http) {
        this.jsonParseReviver = undefined;
        this.http = http ? http : window;
        this.baseUrl = baseUrl !== undefined && baseUrl !== null ? baseUrl : "https://localhost:6001";
    }
    ImportClient.prototype.getLookupDatePatterns = function () {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/backoffice/api/Import/lookups/datePatterns";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
            method: "GET",
            headers: {
    ...
    ImportClient.prototype.processGetLookupDatePatterns = function (response) {
        var _this = this;
    ...
    ImportClient.prototype.getTemplate = function (contentId, contentType) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/backoffice/api/Import/template/{contentId}/{contentType}";
    ...
    ImportClient.prototype.processGetTemplate = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
    ...
    ImportClient.prototype.queue = function (contentId, contentType, req) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/backoffice/api/Import/queue/{contentId}/{contentType}";
        if (contentId === undefined || contentId === null)
            throw new Error("The parameter 'contentId' must be defined.");
        url_ = url_.replace("{contentId}", encodeURIComponent("" + contentId));
        if (contentType === undefined || contentType === null)
    ...
    ImportClient.prototype.processQueue = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
