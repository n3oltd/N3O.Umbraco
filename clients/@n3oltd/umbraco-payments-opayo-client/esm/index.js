...
var OpayoClient = /** @class */ (function () {
    ...
    OpayoClient.prototype.process = function (flowId, req) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Opayo/{flowId}/payment/process";
    ...
    OpayoClient.prototype.processProcess = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
    ...
    OpayoClient.prototype.findPaymentMethods = function (req) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Opayo/paymentMethods/find";
        url_ = url_.replace(/[?&]$/, "");
        var content_ = JSON.stringify(req);
        var options_ = {
            body: content_,
    ...
    OpayoClient.prototype.processFindPaymentMethods = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
    ...
    OpayoClient.prototype.getLookupPaymentMethods = function () {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Opayo/lookups/paymentMethods";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
            method: "GET",
            headers: {
    ...
    OpayoClient.prototype.processGetLookupPaymentMethods = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
    ...
    OpayoClient.prototype.getAllLookups = function (criteria) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Opayo/lookups/all";
        url_ = url_.replace(/[?&]$/, "");
    ...
    OpayoClient.prototype.processGetAllLookups = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
