...
var OpayoClient = /** @class */ (function () {
    ...
    OpayoClient.prototype.completeThreeDSecureFallback = function (flowId, paRes, md, mdx) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Opayo/payments/{flowId}/completeThreeDSecureFallback";
        if (flowId === undefined || flowId === null)
            throw new Error("The parameter 'flowId' must be defined.");
        url_ = url_.replace("{flowId}", encodeURIComponent("" + flowId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then(function (_response) {
            return _this.processCompleteThreeDSecureFallback(_response);
        });
    };
    OpayoClient.prototype.processCompleteThreeDSecureFallback = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
