...
var OpayoClient = /** @class */ (function () {
    ...
    OpayoClient.prototype.completeThreeDSecureChallenge = function (flowId, cRes, paRes) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Opayo/payments/{flowId}/completeThreeDSecure";
        if (flowId === undefined || flowId === null)
            throw new Error("The parameter 'flowId' must be defined.");
        url_ = url_.replace("{flowId}", encodeURIComponent("" + flowId));
        url_ = url_.replace(/[?&]$/, "");
    ...
    OpayoClient.prototype.getApplePaySession = function () {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Opayo/applePaySession";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
            method: "GET",
            headers: {
        ...
        return this.http.fetch(url_, options_).then(function (_response) {
            return _this.processGetApplePaySession(_response);
        });
    };
    OpayoClient.prototype.processGetApplePaySession = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
