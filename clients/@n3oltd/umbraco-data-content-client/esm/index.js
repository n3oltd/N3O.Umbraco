...
var ContentClient = /** @class */ (function () {
    ...
    ContentClient.prototype.getChildContentTypes = function (contentId) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Content/{contentId}/childContentTypes";
        if (contentId === undefined || contentId === null)
            throw new Error("The parameter 'contentId' must be defined.");
        url_ = url_.replace("{contentId}", encodeURIComponent("" + contentId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then(function (_response) {
            return _this.processGetChildContentTypes(_response);
        });
    };
    ContentClient.prototype.processGetChildContentTypes = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
