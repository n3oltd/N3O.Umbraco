...
var ExportClient = /** @class */ (function () {
    function ExportClient(baseUrl, http) {
        this.jsonParseReviver = undefined;
        this.http = http ? http : window;
        this.baseUrl = baseUrl !== undefined && baseUrl !== null ? baseUrl : "https://localhost:6001";
    }
    ExportClient.prototype.getExportableProperties = function (contentId, contentType) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/backoffice/api/Export/exportableProperties/{contentId}/{contentType}";
    ...
    ExportClient.prototype.processGetExportableProperties = function (response) {
        var _this = this;
    ...
    ExportClient.prototype.createExport = function (contentId, contentType, req) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/backoffice/api/Export/export/{contentId}/{contentType}";
        if (contentId === undefined || contentId === null)
            throw new Error("The parameter 'contentId' must be defined.");
        url_ = url_.replace("{contentId}", encodeURIComponent("" + contentId));
        if (contentType === undefined || contentType === null)
    ...
    ExportClient.prototype.processCreateExport = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
