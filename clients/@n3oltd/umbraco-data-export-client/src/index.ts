...
export class ExportClient {
    ...
    getExportableProperties(contentId: string, contentType: string): Promise<void> {
        let url_ = this.baseUrl + "/umbraco/backoffice/api/Export/exportableProperties/{contentId}/{contentType}";
    ...
    createExport(contentId: string, contentType: string, req: ExportReq): Promise<void> {
        let url_ = this.baseUrl + "/umbraco/backoffice/api/Export/export/{contentId}/{contentType}";
        if (contentId === undefined || contentId === null)
            throw new Error("The parameter 'contentId' must be defined.");
        url_ = url_.replace("{contentId}", encodeURIComponent("" + contentId));
        if (contentType === undefined || contentType === null)
