...
var BamboraClient = /** @class */ (function () {
    ...
    BamboraClient.prototype.completePaymentThreeDSecureChallenge = function (flowId, cRes, threeDSessionData) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Bambora/payments/{flowId}/completeThreeDSecureChallenge";
        ...
        return this.http.fetch(url_, options_).then(function (_response) {
            return _this.processCompletePaymentThreeDSecureChallenge(_response);
        });
    };
    BamboraClient.prototype.processCompletePaymentThreeDSecureChallenge = function (response) {
        var _this = this;
