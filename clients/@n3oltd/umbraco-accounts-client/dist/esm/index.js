...
var AccountsClient = /** @class */ (function () {
    ...
    AccountsClient.prototype.getConsentOptions = function () {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Accounts/consentOptions";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
            method: "GET",
            headers: {
        ...
        return this.http.fetch(url_, options_).then(function (_response) {
            return _this.processGetConsentOptions(_response);
        });
    };
    AccountsClient.prototype.processGetConsentOptions = function (response) {
        var _this = this;
