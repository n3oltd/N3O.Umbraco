...
export class EngageClient {
    ...
    updateCurrentAccount(req: AccountReq): Promise<void> {
        let url_ = this.baseUrl + "/umbraco/api/Crm/accounts/current";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUpdateCurrentAccount(_response);
        });
    }
    ...
    getAllLookups(criteria: LookupsCriteria): Promise<CrmLookupsRes> {
        let url_ = this.baseUrl + "/umbraco/api/Crm/lookups/all";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllLookups(response: Response): Promise<CrmLookupsRes> {
        ...
        if (status === 200) {
            ...
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as CrmLookupsRes;
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<CrmLookupsRes>(null as any);
    }
}
