...
var GivingClient = /** @class */ (function () {
    ...
    GivingClient.prototype.getLookupFeedbackSchemes = function () {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/Giving/lookups/feedbackSchemes";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
            method: "GET",
            headers: {
        ...
        return this.http.fetch(url_, options_).then(function (_response) {
            return _this.processGetLookupFeedbackSchemes(_response);
        });
    };
    GivingClient.prototype.processGetLookupFeedbackSchemes = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
