...
var PayPalClient = /** @class */ (function () {
    ...
    PayPalClient.prototype.captureTransaction = function (flowId, req) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/PayPal/payments/{flowId}/captureTransaction";
        if (flowId === undefined || flowId === null)
            throw new Error("The parameter 'flowId' must be defined.");
        url_ = url_.replace("{flowId}", encodeURIComponent("" + flowId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then(function (_response) {
            return _this.processCaptureTransaction(_response);
        });
    };
    PayPalClient.prototype.processCaptureTransaction = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
    ...
    PayPalClient.prototype.getOrCreatePlan = function (flowId, req) {
        var _this = this;
        var url_ = this.baseUrl + "/umbraco/api/PayPal/credentials/{flowId}/getOrCreatePlan";
        if (flowId === undefined || flowId === null)
            throw new Error("The parameter 'flowId' must be defined.");
        url_ = url_.replace("{flowId}", encodeURIComponent("" + flowId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then(function (_response) {
            return _this.processGetOrCreatePlan(_response);
        });
    };
    PayPalClient.prototype.processGetOrCreatePlan = function (response) {
        var _this = this;
        var status = response.status;
        var _headers = {};
        if (response.headers && response.headers.forEach) {
