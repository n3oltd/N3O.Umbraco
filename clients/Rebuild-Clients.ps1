...
n3o-tool clients --url "https://localhost:5001/swagger/Checkout/swagger.json" --language "TypeScript" --output-path "@n3oltd/umbraco-checkout-client" --name "CheckoutClient" --package-name "@n3oltd/umbraco-checkout-client" --package-description "TypeScript client for the N3O Umbraco Checkout"

n3o-tool clients --url "https://localhost:5001/swagger/Cropper/swagger.json" --language "TypeScript" --output-path "@n3oltd/umbraco-cropper-client" --name "CropperClient" --package-name "@n3oltd/umbraco-cropper-client" --package-description "TypeScript client for the N3O Umbraco Cropper"

n3o-tool clients --url "https://localhost:5001/swagger/Donations/swagger.json" --language "TypeScript" --output-path "@n3oltd/umbraco-donations-client" --name "DonationsClient" --package-name "@n3oltd/umbraco-donations-client" --package-description "TypeScript client for the N3O Umbraco Donations"
