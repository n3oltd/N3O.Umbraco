...
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/accounts/docs/swagger/connect-v1.0/swagger.json" --language "CSharp" --output-path "../src/Crm/N3O.Umbraco.Crm.Engage/Clients" --name "AccountsClient" --namespace "N3O.Umbraco.Crm.Engage.Clients" --connect-api
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/cart/docs/swagger/connect-v1.0/swagger.json" --language "CSharp" --output-path "../src/Crm/N3O.Umbraco.Crm.Engage/Clients" --name "CartClient" --namespace "N3O.Umbraco.Crm.Engage.Clients" --connect-api --exclude-models "ApiException|Currency|ProblemDetails|Reference|ReferenceType"
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/crowdfunding/docs/swagger/crowdfunding-v1.0/swagger.json" --language "CSharp" --output-path "../src/Crm/N3O.Umbraco.Crm.Engage/Clients" --name "CrowdfundingClient" --namespace "N3O.Umbraco.Crm.Engage.Clients" --connect-api --exclude-models "AllocationType|ApiException|CalendarSystem|Currency|CurrencyRes|Era|FundDimensionOptions|FundDimensionValues|FundDimensionValuesReq|FundDimensionValuesRes|IsoDayOfWeek|MoneyReq|MoneyRes|NewCustomFieldReq|Price|Pricing|PricingRule|ProblemDetails|Reference|ReferenceType|SponsorshipComponent|TaxReliefRate"