...
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/crowdfunding/docs/swagger/crowdfunding-v1.0/swagger.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Engage/Clients" --name "CrowdfundingClient" --namespace "N3O.Umbraco.Cloud.Engage.Clients" --connect-api --exclude-models "AllocationType|ApiException|CalendarSystem|Currency|CurrencyRes|Era|FundDimensionOptions|FundDimensionValues|FundDimensionValuesReq|FundDimensionValuesRes|IsoDayOfWeek|MoneyReq|MoneyRes|NewCustomFieldReq|Price|Pricing|PricingRule|ProblemDetails|Reference|ReferenceType|SponsorshipComponent|TaxReliefRate|DonationType"

n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/connect/docs/swagger/umbraco-v1.0/swagger.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "ConnectClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/platforms/docs/swagger/umbraco-v1.0/swagger.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "PlatformsClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api --exclude-models "ApiException|ProblemDetails|Country|Currency|DateFormat|DateTimeZone|FundDimensionSelector|NumberFormat|Offset|PublishedBannerAdvert|PublishedBannerAdverts|PublishedFundDimensionToggleOptions|PublishedFundDimensionView|PublishedGoogleAnalyticsTracking|PublishedMetaTracking|PublishedOrganizationInfo|PublishedPaymentTerms|PublishedTerminology|PublishedTheme|PublishedThemeColors|PublishedTikTokTracking|PublishedTracking|UmbracoAddressEntryReq|UmbracoConsentEntryReq|UmbracoFundDimensionReq|UmbracoFundStructureReq|UmbracoSubscriptionSettingsReq|SystemLanguage|TimeFormat|ILocalizationSettings"
