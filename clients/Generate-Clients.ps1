...
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/zakat/docs/swagger/umbraco-v1.0/swagger.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "ZakatClient" --namespace "N3O.Umbraco.Cloud.Zakat.Clients" --connect-api --exclude-models-from "https://beta.n3o.cloud/eu1/api/platforms/docs/swagger/umbraco-v1.0/swagger.json|https://beta.n3o.cloud/eu1/api/platforms/docs/swagger/connect-v1.0/swagger.json|https://beta.n3o.cloud/eu1/api/templates/docs/swagger/connect-v1.0/swagger.json"
