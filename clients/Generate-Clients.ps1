...
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/sponsorships/docs/openapi/connect-v1.0.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "SponsorshipsClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api --exclude-models-from "https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/umbraco-v1.0.json|https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/feedbacks/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/qurbanis/docs/openapi/umbraco-v1.0.json"
