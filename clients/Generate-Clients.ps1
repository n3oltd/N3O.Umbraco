...
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/connect/docs/swagger/umbraco-v1.0/swagger.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "PlatformsClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/connect/docs/swagger/umbraco-v1.0/swagger.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "ConnectClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api --exclude-models "ApiException|ProblemDetails"