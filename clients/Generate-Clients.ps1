...
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/connect/docs/swagger/connect-v1.0/swagger.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud/Clients" --name "ConnectClient" --namespace "N3O.Umbraco.Cloud.Clients.Connect" --connect-api
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/content/docs/swagger/umbraco-v1.0/swagger.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud/Clients" --name "ContentClient" --namespace "N3O.Umbraco.Cloud.Clients.Content" --connect-api
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/platforms/docs/swagger/umbraco-v1.0/swagger.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud/Clients" --name "PlatformsClient" --namespace "N3O.Umbraco.Cloud.Clients.Platforms" --connect-api
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/templates/docs/swagger/connect-v1.0/swagger.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud/Clients" --name "TemplatesClient" --namespace "N3O.Umbraco.Cloud.Clients.Templates" --connect-api